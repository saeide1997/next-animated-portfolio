...
>>>>>>> 701dd785328b68b73684696334be57b7afc548d3
    },
    {
      id: 1,
...
=======
                <div className=" h-screen flex flex-col sm:flex-col xl:flex-row  text-[#634a49] ">
                  <div className=' xl:w-2/5 w-screen sm:w-screen p-20 shadow  bg-[#b29e9a]'>
>>>>>>> 701dd785328b68b73684696334be57b7afc548d3
...
=======
                  <div className= 'p-20 w-screen sm:w-screen flex flex-col justify-between xl:w-3/5 '>
>>>>>>> 701dd785328b68b73684696334be57b7afc548d3
                    <p className="py-10 text-xl 2xl:text-2xl">{item.desc}</p>
                    <p className="py-10 text-red-900 text-xl 2xl:text-2xl">{item.att}</p>
                    <Link
                      href={item.link}
